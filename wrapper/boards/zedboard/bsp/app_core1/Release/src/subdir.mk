...
src/%.o: ../src/%.c
	...
	$(ARM_GCC) -DIO_BASE_ADDR=$(IO_BASE_ADDR) -DUSE_AMP=1 -Wall $(USER_COMPILER_FLAGS) -O2 -I"../../$(FUNCTION_NAME)_multicore_system/include_common" -c -fmessage-length=0 -MT"$@" -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -I ../../zed/export/zed/sw/zed/standalone_ps7_cortexa9_1/bspinclude/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
