...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/VMyfVoJrTg_fun -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=VMyfVoJrTg_fun
...
OBJS = VMyfVoJrTg_fun_initialize.o VMyfVoJrTg_fun_terminate.o VMyfVoJrTg_fun.o
...
%.o : $(START_DIR)/codegen/lib/VMyfVoJrTg_fun/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/VMyfVoJrTg_fun/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/VMyfVoJrTg_fun/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/VMyfVoJrTg_fun/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/VMyfVoJrTg_fun/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
