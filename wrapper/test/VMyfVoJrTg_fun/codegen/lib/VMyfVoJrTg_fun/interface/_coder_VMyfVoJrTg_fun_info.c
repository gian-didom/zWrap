 ...
 * File: _coder_VMyfVoJrTg_fun_info.c
 *
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString("/Users/gianfry/Documents/DLR/zWrap/wrapper/test/"
                          "VMyfVoJrTg_fun/VMyfVoJrTg_fun.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739192.45895833336));
...
/*
 * File trailer for _coder_VMyfVoJrTg_fun_info.c
 *
 * [EOF]
 */
