function [fullInputSizeGCC, fullOutputSizeGCC] = ...
    getSizeAndOffsetsCpp_v2(buildInfo, codedInputs, compileInfoStruct, codedOutputs, packDir, echo)
...
fprintf('Running "%s" %s %s -O0 -c "%s" -o "%s" -g\n', ...
    arm_compiler_path, ...
    defines,...
    includePath, ...
    CPP_test_file,  ...
...
[compilationStatus, ~] = system(sprintf('"%s" %s %s -O0 -c "%s" -o "%s" -g', ...
                                        arm_compiler_path, ...
                                        defines,...
                                        includePath, ...
                                        CPP_test_file,  ...
